...
$('table td').click(function(){
	if ($(this).find('div').hasClass('1')||$(this).find('div').hasClass('0')){
		...
		if (liczbaNiePustych ==1){
			...
			else if (wygrana2()){wygrana2();}
				else if(wygrana3()){wygrana3();}
					else if(wygrana4()){wygrana4();}
						else if (przegrana()){przegrana();}
							else if (przegrana2()){przegrana2();}
								else if(przegrana3()){przegrana3();}
									else if(przegrana4()){przegrana4();}
										else if (step()){step();}
											else if (step2()){step2();}
												else if(step3()){step3();}
													else if(step4()){step4();}
