    ...
    <div class="major">
        ...
        <div class="container2">
            ...
            <form method="post">
                ...
                <br>
                <label id="imieIsset"></label>
                <br>
                <input type="password" name="passwordIsset" placeholder=" Wprowadż hasło">
                <br>
                <label id="hasloIsset"></label>
                <br>
                <input type="submit" name="logoIsset" value="Wejście">
            </form>
            ...
            <br>
            <p>Pod tym adresem <a href="https://github.com/VitaliKaniushok/FirstCode/tree/master/Cheil">na servisie Githuba</a> znajdują się kody tej strony</p>
            <br>
            <p>Przejść na<a href="../index.html"> główną stronę</a>
            </p>
        </div>
    </div>
</body>
